...
const Confirmation = ({ navigation }: ConfirmationScreenProps) => {
  const theme = useTheme();
  const { colors }: { colors: any } = theme;

  return (
    <View style={{ backgroundColor: colors.background, flex: 1 }}>
      <Header title="Confirmation" leftIcon="back" titleRight />
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        ...
        <Text
          style={[
            {
              color: theme.dark ? "rgba(180, 180, 180, 0.7)" : "#4E4E4E",
              marginLeft: 20,
              fontSize: 17,
            },
          ]}
        ...
        >
          {ConfirmationData.map((data: any, index) => {
            return (
              <TouchableOpacity
        ...
        <View style={[GlobalStyleSheet.container, { paddingBottom: 0 }]}>
          <View style={[styles.bottomCard, { backgroundColor: colors.card }]}>
            ...
            <View style={[GlobalStyleSheet.flex, { paddingVertical: 5 }]}>
              ...
              <Text style={[styles.title1, { color: "#8ABE12" }]}>$4.05</Text>
            </View>
          </View>
        </View>
      </ScrollView>
